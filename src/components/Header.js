...
const Header = () => {
  ...
  return (
    // bg-black sm:bg-blue-900 md:bg-green-900 this means black is for mobile,when we go up for medium devices like tab is is blue and for above like greater than medium devices we have desktop for that we have green
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between">
        ...
        {user && (
          ...
          <img alt="usericon" className="hidden md:block h-12 w-12"
            src={user?.photoURL}
          />
